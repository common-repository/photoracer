...
{
	$qchange = "update ".$wpdb->prefix."photoracer_admin set active_from='".$photorace_init_day."' WHERE raceid=$rid";
	$wpdb->query($qchange);
}
?>
<div class="wrap">
...
function showFlatCalendar() {
 ...
 <div class="wrap">
	  <h2>Cambia la data di inizio del concorso fotografico</h2>
	  concorso:<br />
	  ...
	  <form name="form1" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
		  ...
		  <fieldset class="options">
			  <legend>Nuova data di inizio del concorso Fotografico</legend>
